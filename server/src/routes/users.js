...
// Routes
userRouter.route('/signup').post(validateBody(schemas.signUpSchema), usersController.signUp);
...
userRouter
	...
	.put(
		passport.authenticate('jwt', { session: false }),
		validateBody(schemas.paymentSchema),
		usersController.setPayments
	);
